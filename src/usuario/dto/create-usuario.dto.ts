...
export class CreateUsuarioDto {
  ...
  @ApiProperty({ example: 'maria@aluno.cps.sp.gov.br', description: 'Email único para login' })
  @IsEmail()
  usuStrEmail!: string;
  ...
  @ApiProperty({ example: 'Grupo', description: 'Tipo de usuário', enum: ['Empreendedor', 'Coordenador', 'Grupo'] })
  @IsString()
