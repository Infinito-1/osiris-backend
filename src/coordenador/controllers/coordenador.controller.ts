...
export class CoordenadorController {
  ...
  @Get('dashboard')
  @Roles('Coordenador')
  @ApiOperation({ summary: 'Obter métricas consolidada do painel do Coordenador logado' })
  @ApiResponse({ status: 200, description: 'Dados do dashboard gerados com sucesso.' })
  ...
  @Post()
  @Roles('Admin')
  @ApiOperation({ summary: 'Vincular um novo perfil de Coordenador a um usuário base (Apenas Admin)' })
  @ApiResponse({ status: 21, description: 'Perfil criado e papel de usuário atualizado.' })
  ...
  @Put(':id')
  @Roles('Admin')
  @ApiOperation({ summary: 'Atualizar dados cadastrais do coordenador (Apenas Admin)' })
  ...
  @Put(':id/inativar')
  @Roles('Admin')
  @ApiOperation({ summary: 'Inativar a conta de um coordenador bloqueando o acesso dele (Apenas Admin)' })
  @ApiResponse({ status: 200, description: 'Coordenador e usuário base desativados.' })
  ...
  @ApiOperation({ summary: 'Remover o registro de coordenação do banco de dados (Apenas Admin)' })
  ...
  @Roles('Coordenador')
  @ApiOperation({ summary: 'Aprovar demanda classificada e disponibilizá-la na galeria pública (RN-02/RN-15)' })
  @ApiResponse({ status: 200, description: 'Demanda aprovada e e-mail enviado ao empreendedor.' })
  @ApiResponse({ status: 400, description: 'Aprovação negada: demanda não classificada.' })
  ...
  @Roles('Coordenador')
  @ApiOperation({ summary: 'Aceitar ou Recusar a candidatura de um grupo estudantil para um projeto (RN-06/RN-15)' })
  @ApiResponse({ status: 200, description: 'Status atualizado e e-mail enviado ao líder do grupo.' })
